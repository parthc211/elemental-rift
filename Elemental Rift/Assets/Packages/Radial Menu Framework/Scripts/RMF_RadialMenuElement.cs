...
public class RMF_RadialMenuElement : MonoBehaviour {
    ...
    public void highlightThisElement(PointerEventData p) {
        ...
        ExecuteEvents.ExecuteHierarchy(button.gameObject, p, ExecuteEvents.pointerEnterHandler);
        active = true;
    ...
    public void unHighlightThisElement(PointerEventData p) {
        ...
        ExecuteEvents.ExecuteHierarchy(button.gameObject, p, ExecuteEvents.pointerExitHandler);
        active = false;
