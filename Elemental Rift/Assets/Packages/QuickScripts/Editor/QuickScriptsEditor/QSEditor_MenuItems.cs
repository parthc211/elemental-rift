...
public class QSEditor_MenuItems : Editor {
	...
	[MenuItem ("GameObject/Quick Scripts/Presets/Quick Trigger")]								// Trigger
	...
	[MenuItem ("GameObject/Quick Scripts/Presets/Quick Spawner")]								// Spawner
	...
	[MenuItem ("GameObject/Quick Scripts/Presets/Quick Teleport")]								// Teleport
	...
	[MenuItem ("GameObject/Quick Scripts/Presets/Quick Light")]									// Light
	static void CreateLight(MenuCommand quickLight)
	{
		CreateGameObject (quickLight, "Quick Light", false, typeof(QuickLight));
	}

	[MenuItem ("GameObject/Quick Scripts/Presets/Quick Pendulum")]								// Pendulum
	...
	/// <param name="type">Type. 0 = Cube | 1 = Sphere | 2 = Collider </param>
